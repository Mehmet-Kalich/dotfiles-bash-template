...
" Enable syntax highlighting (makes scripts colorful)
syntax on

" Show line numbers
set number

" Auto-indent for shell scripts
filetype plugin indent on
set autoindent
set shiftwidth=4
set tabstop=4

" Enable filetype detection for .sh files
augroup filetypedetect
  au BufNewFile,BufRead *.sh set filetype=sh
augroup END

" Optional: Use 256 colors for better highlighting
set t_Co=256
